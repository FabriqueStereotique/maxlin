...
#define CUSTOM_MACHINE_NAME "C&M MAKER"
...
#define TEMP_SENSOR_1 0 // niet in gebruik
#define TEMP_SENSOR_2 0 // niet in gebruik
#define TEMP_SENSOR_3 0 // niet in gebruik
